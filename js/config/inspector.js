...
(function () {
    ...
    const options = {
        ...
        // samir Device Lists
        deviceList: [
            { value: 'flow_1', content: 'Flow 1' },
            { value: 'flow_2', content: 'Flow 2' },
            { value: 'flow_3', content: 'Flow 3' },
            { value: 'flow_4', content: 'Flow 4' }
        ],
        ...
        imageIcons: [
            { value: 'assets/image-icon11.svg', content: '<img height="42px" src="assets/image-icon11.svg"/>' },
